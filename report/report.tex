...
\begin{figure}[H]
	\centering
	\subfloat[1 mesh refinement, 8 elements]{\label{fig:mesh_1}\includegraphics[width=0.45\textwidth]{mesh_r1.pdf}} \;
	\subfloat[2 mesh refinements, 32 elements]{\label{fig:mesh_2}\includegraphics[width=0.45\textwidth]{mesh_r2.pdf}} \\
	\subfloat[3 mesh refinements, 128 elements]{\label{fig:mesh_3}\includegraphics[width=0.45\textwidth]{mesh_r3.pdf}} \;
	\subfloat[4 mesh refinements, 512 elements]{\label{fig:mesh_4}\includegraphics[width=0.45\textwidth]{mesh_r4.pdf}}
